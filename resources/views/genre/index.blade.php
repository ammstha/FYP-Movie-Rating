...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        ...
        <button type="button" class="btn btn-primary pull-right" data-toggle="modal"
                data-target="#addgenre">Add New Genre
        </button>
    </div>
                ...
                <div class="content table-responsive table-full-width">
                    <table class="table table-hover table-striped">
                        ...
                        @foreach ($genres as $genre)
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm" data-toggle="modal"
                                            data-target="#updategenre-{{ $genre->id }}">Edit
                                    </button>
                            ...
                            <div class="modal fade" id="updategenre-{{ $genre->id }}" role="dialog">
                                <div class="modal-dialog modal-sm">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            {{ Form::model($genre, ['route' => ['genres.update', $genre->slug], 'method' => "PUT"]) }}
        ...
        <div class="modal-dialog modal-sm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{ Form::submit('Create New Genre', ['class' => 'btn btn-primary btn-block btn-h1-spacing mt-3']) }}
